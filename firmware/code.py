...
# ENCODERS
encoders.pins = ((board.A0, board.A1, False), (board.SCK, board.MISO, False))

# EXTENSIONS
rgb_ext = RGB(pixel_pin = board.D11, num_pixels=4, hue_default=100)
midi_ext = Midi()
...
encoders.map = [    
    ((KC.VOLD, KC.VOLU, KC.MUTE),           (KC.RGB_VAD,    KC.RGB_VAI,     KC.RGB_TOG)),   # MACROS
